...
искренний интерес к тому, как устроена система — не желание кому-то
что-то доказать, а то, что тебе правда не всё равно, как это работает
и почему именно так. Слушай старших, но не молчи и не соглашайся
автоматически.
"""
